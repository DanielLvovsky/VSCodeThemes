...
const platforms = [
  {
    name: 'Zoko Theme',
    url: 'https://marketplace.visualstudio.com/items?itemName=daniel-lvovsky.zoko-theme',
    logo: VSCode,
  },
  {
    name: 'Galax Theme',
    url: 'https://marketplace.visualstudio.com/items?itemName=daniel-lvovsky.galax-theme',
    logo: Sublime,
  },
  {
    name: 'MintLight Theme',
    url: 'https://marketplace.visualstudio.com/items?itemName=daniel-lvovsky.mintlight-theme',
    logo: Atom,
  },
  {
    name: 'MintDark Theme',
    url: 'https://marketplace.visualstudio.com/items?itemName=daniel-lvovsky.mintdark-theme',
    logo: iTerm,
  },
];
